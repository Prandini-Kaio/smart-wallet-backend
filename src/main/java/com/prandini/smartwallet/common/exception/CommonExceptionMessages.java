...
public class CommonExceptionMessages {
    ...
    private final static String NAO_ENCONTRADO_VALOR = "%s não encontrado(a) com valor %s.";
    ...
    public static String naoEncontrado(String nome, String valor){
        return String.format(NAO_ENCONTRADO_VALOR, nome, valor);
    }
